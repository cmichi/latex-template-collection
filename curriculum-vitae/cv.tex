...
% the color which will be used in the cv
%\definecolor{color1}{RGB}{39, 56, 132}
%\definecolor{color1}{RGB}{48, 76, 84}
...
% the following command is used to emphasize a certain author within the publications
\newcommand{\makeauthorbold}[1]{%
\DeclareNameFormat{author}{%
  \edef\tempname{{#1}}%
  \ifnumequal{\value{listcount}}{1}
    {\ifnumequal{\value{liststop}}{1}
      {\expandafter\ifstrequal\tempname{##1}{\textbf{##3\addspace ##1\addcomma\isdot}}{##3\addspace ##1\addcomma\isdot}}
      {\expandafter\ifstrequal\tempname{##1}{\textbf{##3\addspace ##1}}{##3\addspace ##1}}}
    {\ifnumless{\value{listcount}}{\value{liststop}}
      {\expandafter\ifstrequal\tempname{##1}{\textbf{\addcomma\addspace ##3\addspace ##1}}{\addcomma\addspace ##3\addspace ##1}}
      {\expandafter\ifstrequal\tempname{##1}{\textbf{\addcomma\addspace ##3\addspace ##1\addcomma\isdot}}{\addcomma\addspace ##3\addspace ##1\addcomma\isdot}}%
    }%
}%
}
\makeauthorbold{Asimov}
